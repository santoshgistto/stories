...
const storiesEditor = {
  ...sharedConfig,
  entry: {
    'edit-story': './src//assets/src/edit-story/index.js',
  },
  plugins: [
...
const dashboard = {
  ...sharedConfig,
  entry: {
    'stories-dashboard': './src/assets/src/dashboard/index.js',
  },
  plugins: [
    ...sharedConfig.plugins,
    new WebpackBar({
...
const storyEmbedBlock = {
  ...sharedConfig,
  entry: {
    'web-stories-embed-block': './src/assets/src/story-embed-block/index.js',
  },
  plugins: [
    process.env.BUNDLE_ANALZYER && new BundleAnalyzerPlugin(),
    new DependencyExtractionWebpackPlugin({
...
const activationNotice = {
  ...
  entry: {
    'web-stories-activation-notice':
      './src/packages/activation-notice/src/index.js',
  },
  plugins: [
    ...sharedConfig.plugins,
    new WebpackBar({
